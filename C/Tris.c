...
void InserimentoValori(char x[][3])
{
    ...
    for (int i = 0; i < 9; i++)
    {
        ...
        if (i % 2 == 0)
        {
            printf("\nX] Inserire riga e colonna:\n");
        }
        else
        {
            printf("\nO] Inserire riga e colonna:\n");
        }
        ...
        while (riga < 0 || riga > 2)
        {
            printf("Valore non valido. Inserire riga (0-2): ");
            scanf("%d", &riga);
        }
        ...
        {
            printf("Valore non valido. Inserire colonna (0-2): ");
            scanf("%d", &colonna);
        }


        while (x[riga][colonna] != ' ')
        {
