...
int CalcolaDistanza(int tesoroRiga, int tesoroColonna, int giocatoreRiga, int giocatoreColonna) {
    ...
    if (giocatoreRiga == tesoroRiga) {
        if (giocatoreColonna == tesoroColonna) {
            distanza = 0;
        } else if (giocatoreColonna < tesoroColonna) {
            distanza = tesoroColonna - giocatoreColonna;
        } else {
            distanza = giocatoreColonna - tesoroColonna;
        }
    } else if (giocatoreColonna == tesoroColonna) {
        if (giocatoreRiga < tesoroRiga) {
            distanza = tesoroRiga - giocatoreRiga;
        } else {
            distanza = giocatoreRiga - tesoroRiga;
        }
    }
